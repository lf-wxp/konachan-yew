...
const F = "GET", C = (s) => s && typeof s == "object" ? s : { handle: s };
class R {
  /**
...
class de {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: i, matchOptions: c } = this._strategy, o = await self.caches.open(i), h = this.hasCallback("cacheDidUpdate"), g = h ? await oe(
...
class xe extends D {
   ...
   */
  constructor(e = {}) {
    super(e), this.plugins.some((t) => "cacheWillUpdate" in t) || this.plugins.unshift($), this._networkTimeoutSeconds = e.networkTimeoutSeconds || 0;
  }
  /**
   * @private
   * @param {Request|string} request A request to run this strategy for.
...
class Ee extends D {
   ...
   */
  constructor(e = {}) {
    super(e), this.plugins.some((t) => "cacheWillUpdate" in t) || this.plugins.unshift($);
  }
  /**
   * @private
   * @param {Request|string} request A request to run this strategy for.
...
const Q = /* @__PURE__ */ new WeakMap(), N = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap();
function Te(s) {
...
function Ie(s) {
  return typeof s == "function" ? Me(s) : (s instanceof IDBTransaction && Le(s), Ue(s, ke()) ? new Proxy(s, M) : s);
}
function f(s) {
  ...
  if (P.has(s))
    return P.get(s);
  const e = Ie(s);
  return e !== s && (P.set(s, e), K.set(e, s)), e;
}
const T = (s) => K.get(s);
function Ke(s, e, { blocked: t, upgrade: n, blocking: a, terminated: r } = {}) {
  ...
  }), t && i.addEventListener("blocked", () => t()), c.then((o) => {
    r && o.addEventListener("close", () => r()), a && o.addEventListener("versionchange", () => a());
  }).catch(() => {
  }), c;
}
...
const ve = ["get", "getKey", "getAll", "getAllKeys", "count"], Se = ["put", "add", "delete", "clear"], L = /* @__PURE__ */ new Map();
function B(s, e) {
...
const Oe = "workbox-expiration", y = "cache-entries", j = (s) => {
...
class We {
   ...
   */
  async getDb() {
    return this._db || (this._db = await Ke(Oe, 1, {
...
be();
_e([{"revision":null,"url":"assets/bg0-9d537c2a.js"},{"revision":null,"url":"assets/bg1-57e8d9b2.js"},{"revision":null,"url":"assets/bg10-4605683d.js"},{"revision":null,"url":"assets/bg11-ec53cfed.js"},{"revision":null,"url":"assets/bg12-7ac228ed.js"},{"revision":null,"url":"assets/bg13-0f048610.js"},{"revision":null,"url":"assets/bg14-407b5e11.js"},{"revision":null,"url":"assets/bg15-c72387d4.js"},{"revision":null,"url":"assets/bg16-c1145c42.js"},{"revision":null,"url":"assets/bg17-80998080.js"},{"revision":null,"url":"assets/bg18-6b3788be.js"},{"revision":null,"url":"assets/bg19-028eb946.js"},{"revision":null,"url":"assets/bg2-3580c6b1.js"},{"revision":null,"url":"assets/bg20-d4446a7e.js"},{"revision":null,"url":"assets/bg3-11e1d1b2.js"},{"revision":null,"url":"assets/bg4-36e5bbd7.js"},{"revision":null,"url":"assets/bg5-c7d0292e.js"},{"revision":null,"url":"assets/bg6-df4b4ad5.js"},{"revision":null,"url":"assets/bg7-10171a3e.js"},{"revision":null,"url":"assets/bg8-50b4c105.js"},{"revision":null,"url":"assets/bg9-7a90ae7c.js"},{"revision":null,"url":"assets/index-c9b0fb54.css"},{"revision":null,"url":"assets/index-f9fd9fbf.js"},{"revision":"f196d1cb399c01194b4a8164c4786aee","url":"index.html"},{"revision":"1872c500de691dce40960bb85481de07","url":"registerSW.js"},{"revision":"5045fa9edfb4abf6c30c6d1c1f9e2832","url":"splashscreen.html"},{"revision":"bba43212154236fcb8ae773ff4ba8784","url":"favicon.ico"},{"revision":"c6c8267003deb3ba8b0985392e06eb39","url":"apple-touch-icon.png"},{"revision":"1e55fb0a41a0dfe2cbced40e10016955","url":"icon.jpg"},{"revision":"c8a1f1af23a9f4402c80b67dc51b8a6b","url":"manifest.webmanifest"}].concat([{ url: "/" }]));
x(
